...
date: 'Lab: Mon. Feb.~15 Due: Mon. Feb.~22.'
fontfamily: mathptmx
fontsize: 12pt
output:
  pdf_document:
...
a) Change the surface albedo from "Earth's average" to "Asphalt".
   * What is the albedo?
   * How much does the shortwave light absorbed by the surface change?
   * How much does the shortwave light going out to space change?
   * How much does the longwave light absorbed by the surface change?
   * How much does the longwave light going out to space change?
